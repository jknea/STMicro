 ...
 * @file           : main.c
 * @author         : jknea
 * @brief          : Provides the interface for STM32F446 GPIO pins
 ******************************************************************************
 *
...
typedef enum {LOW, HIGH} logic_t;
typedef enum {INPUT, OUTPUT, ALTERNATE, ANALOG} pinmode_t;
typedef enum
{
...
void digitalWrite(pin_t pin_name, logic_t mode);
